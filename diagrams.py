...
def init_plot(x, y, z):
    ...
    if figure is None:
        ...
        plot1.set_title("diagram 1")
        plot1.set_xlabel("X")
        plot1.set_ylabel("Y")
        plot2.set_title("diagram 2")
        plot2.set_xlabel("X")
        plot2.set_ylabel("Y")
...
def show_values_2d_1(values, range_x = (-1.0, 1.0), range_y = (-1.0, 1.0), steps_count = 20):
    global colors_bar1, plot1, figure, pcolor1
...
def show_values_2d_2(values, range_x = (-1.0, 1.0), range_y = (-1.0, 1.0), steps_count = 20):
